package org.juqkai.demo.support.log;

import org.juqkai.demo.support.log.impl.Log4jLogAdapter;
import org.juqkai.demo.support.log.impl.NopLog;
import org.juqkai.demo.support.log.impl.SystemLogAdapter;
...
public final class Logs {
    ...
    public static void init() {
        try {
            ...
            SystemLogAdapter slog = new SystemLogAdapter();
            adapter = slog;
            if (log4j.canWork()) {
                adapter = log4j;
            }
